...
class CustomButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ButtonStyle flatButtonStyle = TextButton.styleFrom(
      backgroundColor: onPressed == null ? Theme.of(context).disabledColor.withValues() : transparent
    ...
    return Center(child: SizedBox(width: width ?? Dimensions.webMaxWidth, child: Padding(
      ...
      child: TextButton(
        ...
        child: isLoading ? Center(child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('Loading', style: fontMedium.copyWith(color: Colors.black)),
        ]),
          ...
          Text(buttonText, textAlign: TextAlign.center,  style: isBold ? fontBold.copyWith(
